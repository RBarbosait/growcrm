          ...
          <div className="space-y-6">
            ...
            {steps.map((step, index) => {
              ...
              return (
                <article
                  key={step.number}
                  className="relative rounded-3xl border border-zinc-200 bg-white p-7 md:p-9"
                >
        ...
        <div className="mx-auto max-w-5xl border-t border-zinc-200 pt-12">
          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
            ...
            <Link href="/auth/register" className="shrink-0">
              <Button className="h-12 rounded-full bg-emerald-900 px-7 font-semibold hover:bg-emerald-800">
                Comenzar gratis
